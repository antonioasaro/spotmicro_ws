...
void ssd1306_pattern_task(void *ignore)
{
...
void ssd1306_clear_task(void *ignore)
{
...
void ssd1306_contrast_task(void *ignore)
{
	i2c_cmd_handle_t cmd;
...
void ssd1306_scroll_task(void *ignore)
{
	esp_err_t espRc;
...
void ssd1306_text_task(const void *arg_text)
{
