...
#define ANTONIO
#ifdef ANTONIO
#define SPOT_MICRO_MOTION_CMD_SUBSCRIBERS 7
...
private:
  ...
  ServoArray servo_array_absolute_;
...
#ifdef ANTONIO
  std_msgs__msg__String lcd_state_string_msg_;
  geometry_msgs__msg__Twist lcd_vel_cmd_msg_;
  geometry_msgs__msg__Vector3 lcd_angle_cmd_msg_;
#else
